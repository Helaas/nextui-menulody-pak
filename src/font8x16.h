#ifndef MENULODY_FONT8X16_H
#define MENULODY_FONT8X16_H

/*
 * 8x16 VGA-style bitmap font covering ASCII 32-126.
 * Each glyph is 16 bytes (one byte per row, MSB = leftmost pixel).
 * Based on the standard VGA/CP437 8x16 font.
 */
